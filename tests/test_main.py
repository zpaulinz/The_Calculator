...
class TestCalculatorMenu(unittest.TestCase):
    ...
    @patch('builtins.input', side_effect=['2', '5', '3', '0'])  
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('builtins.input', side_effect=['3', '4', '6', '0'])
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('builtins.input', side_effect=['4', '6', '2', '0']) 
    @patch('sys.stdout', new_callable=StringIO)
    ...
    def test_invalid_operation(self, mock_stdout, mock_input):
        main()
        output = mock_stdout.getvalue()
        self.assertIn("Error: Invalid choice. Please select a valid operation (0-5).", output)
        self.assertIn("Exit", output)

    @patch('builtins.input', side_effect=['4', '6', '0', '0']) 
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('builtins.input', side_effect=['1', '1000000000', '1000000000', '0'])  
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('builtins.input', side_effect=['4', '5', '3', '0'])
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('builtins.input', side_effect=['1', '2', '3', '2', '3', '2', '0'])
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('builtins.input', side_effect=['1', 'abc', '5', '3', '0'])
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('builtins.input', side_effect=['4', '1', '3', '0'])
    @patch('sys.stdout', new_callable=StringIO)
    ...
    @patch('sys.stdout', new_callable=StringIO)
    def test_calculator_exponentiation(self, mock_stdout, mock_input):
        main()
        output = mock_stdout.getvalue()

        self.assertIn("The result is: 8.0", output)  # 2^3 = 8
        self.assertIn("Exit", output)

    @patch('builtins.input', side_effect=['5', '4', '0.5', '0'])  
    @patch('sys.stdout', new_callable=StringIO)
    def test_calculator_exponentiation_fractional(self, mock_stdout, mock_input):
        main()
        output = mock_stdout.getvalue()

        self.assertIn("The result is: 2.0", output)  # 4^(1/2) = sqrt(4) = 2
        self.assertIn("Exit", output)

    @patch('builtins.input', side_effect=['5', '100', '2', '0'])  
    @patch('sys.stdout', new_callable=StringIO)
    def test_calculator_exponentiation_large_numbers(self, mock_stdout, mock_input):
        main()
        output = mock_stdout.getvalue()

        self.assertIn("The result is: 10000.0", output)  # 100^2 = 10000
        self.assertIn("Exit", output)

    @patch('builtins.input', side_effect=['5', '2', '-3', '0'])  
    @patch('sys.stdout', new_callable=StringIO)
    def test_calculator_exponentiation_negative_exponent(self, mock_stdout, mock_input):
        main()
        output = mock_stdout.getvalue()
